...
import com.hzq.rpc.core.enums.MessageStatus;
...
import com.hzq.rpc.server.handler.RpcRequestHandler;
...
public class NettyRpcRequestHandler extends SimpleChannelInboundHandler<RpcMessage> {
    ...
    private static final ThreadPoolExecutor threadPool = ThreadPoolFactory.getDefaultThreadPool();
    //private static final ThreadPoolExecutor threadPool = new ThreadPoolExecutor(10, 20, 60L, TimeUnit.SECONDS, new ArrayBlockingQueue<>(1000));
